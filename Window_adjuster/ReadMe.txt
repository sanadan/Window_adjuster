========================================================================
       WIN32 アプリケーション : Window_adjustor
========================================================================


AppWizard はこの Window_adjustor アプリケーションを作成しました。  

このファイルには Window_adjustor アプリケーションを構成している各ファイルの概要
説明が含まれています。
...
res\Window_adjustor.ico
    このファイルは、アプリケーションのアイコンとして使用されるアイコンファイル(32x32) です。
    このアイコンはリソース ファイル Window_adjustor.rc によってインクルードされます。
small.ico
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済みヘッダーファイル (PCH) Window_adjustor.pch
